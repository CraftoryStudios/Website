...
including Electric Furnaces, Electric Foundrys for combining materials,
Energy Cells for storing energy, Generators for making it and even a
...
prepared at this stage its pretty slow. Iron Foundry Recipe

3\. Before we start generating energy we need one more component,
Magnetised Iron. Craft a Engineers Hammer and a Magnetisation Table,
...
also make Electric Furnaces which are faster than regular ones. Craft
one of these and plop it down next to the generator so its touching.
Electric Furance Recipe
...
energy cells. Power Connector Recipe
